   ...
   public static WallState[,] Generate(int width, int height, out Vector3 startPosition)
{
    ...
    var rng = new System.Random(); //kdyžtak smazat - vytváří to random exit a random začátek
    ...
    startPosition = new Vector3(-width / 2, -1, -height / 2 + startY); // Nastavte výšku kamery na 1, abyste ji umístili nad podlahou
